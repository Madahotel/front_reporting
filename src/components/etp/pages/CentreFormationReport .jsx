...
const CentreFormationReport = () => {
  ...
  useEffect(() => {
    ...
    const applyFilters = () => {
      ...
      if (selectedCfp !== "all") {
        currentFiltered = currentFiltered.filter(
          (formation) => formation.cfp_name === selectedCfp
        );
      }
        ...
        <div className="bg-white p-20 rounded-xl">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="md:col-span-3">
              <label htmlFor="select_cfp" className="sr-only">
                Filtrer par Centre de Formation
              </label>
              <select
                id="select_cfp"
                      ...
                      >
                        ...
                        <td
                          className={`px-3 py-3 whitespace-nowrap text-sm 
                            ${formation.project_type === "Intra" ? " text-blue-500" : ""}
                            ${formation.project_type === "Inter" ? " text-green-500" : ""}
                            ${formation.project_type === "Externe" ? "text-red-500" : ""}
                        `}
                        >
